...
class Ui_form_window(object):
    def setupUi(self, form_window):
        ...
        self.input_dependencia_id_lider = QtWidgets.QLineEdit(self.centralwidget)
        self.input_dependencia_id_lider.setGeometry(QtCore.QRect(30, 130, 181, 20))
        self.input_dependencia_id_lider.setObjectName("input_dependencia_id_lider")
    ...
    def retranslateUi(self, form_window):
        ...
        self.label_3.setText(_translate("form_window", "Ingrese el ID del lider de la dependencia:"))
